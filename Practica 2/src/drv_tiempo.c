...
static uint64_t HAL_TICKS_PER_US;     // 15 ticks por microsegundo
#define HAL_TICKS_PER_MS 1000 // 15,000 ticks por milisegundo
...
Tiempo_ms_t drv_tiempo_actual_ms(void) {
    ...
    return ticks /(HAL_TICKS_PER_US *	HAL_TICKS_PER_MS);
}
